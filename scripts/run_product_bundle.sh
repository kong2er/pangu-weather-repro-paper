...
if [[ "${1:-}" == "--help" ]]; then
  echo "Usage: scripts/run_product_bundle.sh [--force] [--with-geo] [--vars z500,t2m,u10] [--hours 24,30] [--kinds fill,diff,vector,msl_wind] [--impl auto|native|blueprint] [--rollout-dir PATH]"
