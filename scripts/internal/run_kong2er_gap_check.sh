...
RUN_E_VERIFY=$(has "$ROOT_DIR/scripts/internal/run_e_stage_verify.sh")
...
- 若某项为 false，请优先查看 docs/_archive/BLUEPRINT_EQUIV_CHECKLIST.md 与 docs/DELIVERY_SUMMARY.md 的对应阶段。
